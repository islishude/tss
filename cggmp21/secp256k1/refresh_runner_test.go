...
func (t *cggmpRefreshRunnerTransport) Send(context.Context, tss.Envelope) error {
	t.sent++
	return nil
}

func (t *cggmpRefreshRunnerTransport) Broadcast(context.Context, tss.Envelope) error {
	t.sent++
	return nil
}

func (*cggmpRefreshRunnerTransport) Receive(context.Context) (tss.InboundEnvelope, error) {
