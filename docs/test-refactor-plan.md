...
### 6.2 Subtest Parallelism

When a table-driven subtest calls `t.Parallel()`, capture the loop variable:
...
This is mandatory. Do not rely on closure behavior.

### 6.3 One Function, One Behavior Family
