...
//
// Autogenerated: fiat_crypto word-by-word-montgomery --lang Go --no-wide-int --relax-primitive-carry-to-bitwidth 32,64 --cmovznz-by-mul --internal-static --package-case flatcase --public-function-case UpperCamelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case camelCase --no-prefix-fiat --doc-newline-in-typedef-bounds --doc-prepend-header 'Code generated by Fiat Cryptography. DO NOT EDIT.' --doc-text-before-function-name ” --doc-text-before-type-name ” --package-name ed25519scalar ” 64 '2^252 + 27742317777372353535851937790883648493' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
//
// curve description (via package name): ed25519scalar
//
...
func Mul(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	x30 := (uint64(uint1(x29)) + x25)
	var x32 uint64
	_, x32 = bits.Add64(x11, x26, uint64(0x0))
	var x33 uint64
	var x34 uint64
	x33, x34 = bits.Add64(x13, x28, uint64(uint1(x32)))
	var x35 uint64
	var x36 uint64
	x35, x36 = bits.Add64(x15, x30, uint64(uint1(x34)))
	var x37 uint64
	var x38 uint64
	x37, x38 = bits.Add64(x17, x22, uint64(uint1(x36)))
	var x39 uint64
	var x40 uint64
	x39, x40 = bits.Add64(x19, x23, uint64(uint1(x38)))
	var x41 uint64
	var x42 uint64
	...
	var x64 uint64
	var x65 uint64
	x64, x65 = bits.Add64(uint64(uint1(x40)), x55, uint64(uint1(x63)))
	var x66 uint64
	...
	x76 := (uint64(uint1(x75)) + x71)
	var x78 uint64
	_, x78 = bits.Add64(x56, x72, uint64(0x0))
	var x79 uint64
	var x80 uint64
	x79, x80 = bits.Add64(x58, x74, uint64(uint1(x78)))
	var x81 uint64
	var x82 uint64
	x81, x82 = bits.Add64(x60, x76, uint64(uint1(x80)))
	var x83 uint64
	var x84 uint64
	x83, x84 = bits.Add64(x62, x68, uint64(uint1(x82)))
	var x85 uint64
	var x86 uint64
	x85, x86 = bits.Add64(x64, x69, uint64(uint1(x84)))
	x87 := (uint64(uint1(x86)) + uint64(uint1(x65)))
	var x88 uint64
	var x89 uint64
	...
	var x98 uint64
	var x99 uint64
	x98, x99 = bits.Add64(x93, x90, uint64(uint1(x97)))
	var x100 uint64
	var x101 uint64
	x100, x101 = bits.Add64(x91, x88, uint64(uint1(x99)))
	x102 := (uint64(uint1(x101)) + x89)
	var x103 uint64
	var x104 uint64
	...
	x123 := (uint64(uint1(x122)) + x118)
	var x125 uint64
	_, x125 = bits.Add64(x103, x119, uint64(0x0))
	var x126 uint64
	var x127 uint64
	x126, x127 = bits.Add64(x105, x121, uint64(uint1(x125)))
	var x128 uint64
	var x129 uint64
	x128, x129 = bits.Add64(x107, x123, uint64(uint1(x127)))
	var x130 uint64
	var x131 uint64
	x130, x131 = bits.Add64(x109, x115, uint64(uint1(x129)))
	var x132 uint64
	var x133 uint64
	x132, x133 = bits.Add64(x111, x116, uint64(uint1(x131)))
	x134 := (uint64(uint1(x133)) + uint64(uint1(x112)))
	var x135 uint64
	var x136 uint64
	...
	var x154 uint64
	var x155 uint64
	x154, x155 = bits.Add64(x130, x145, uint64(uint1(x153)))
	var x156 uint64
	var x157 uint64
	x156, x157 = bits.Add64(x132, x147, uint64(uint1(x155)))
	var x158 uint64
	var x159 uint64
	...
	x170 := (uint64(uint1(x169)) + x165)
	var x172 uint64
	_, x172 = bits.Add64(x150, x166, uint64(0x0))
	var x173 uint64
	var x174 uint64
	x173, x174 = bits.Add64(x152, x168, uint64(uint1(x172)))
	var x175 uint64
	var x176 uint64
	x175, x176 = bits.Add64(x154, x170, uint64(uint1(x174)))
	var x177 uint64
	var x178 uint64
	x177, x178 = bits.Add64(x156, x162, uint64(uint1(x176)))
	var x179 uint64
	var x180 uint64
	x179, x180 = bits.Add64(x158, x163, uint64(uint1(x178)))
	x181 := (uint64(uint1(x180)) + uint64(uint1(x159)))
	var x182 uint64
	var x183 uint64
	x182, x183 = bits.Sub64(x173, 0x5812631a5cf5d3ed, uint64(0x0))
	var x184 uint64
	var x185 uint64
	x184, x185 = bits.Sub64(x175, 0x14def9dea2f79cd6, uint64(uint1(x183)))
	var x186 uint64
	var x187 uint64
	x186, x187 = bits.Sub64(x177, uint64(0x0), uint64(uint1(x185)))
	var x188 uint64
	var x189 uint64
	x188, x189 = bits.Sub64(x179, 0x1000000000000000, uint64(uint1(x187)))
	var x191 uint64
	_, x191 = bits.Sub64(x181, uint64(0x0), uint64(uint1(x189)))
	var x192 uint64
	cmovznzU64(&x192, uint1(x191), x182, x173)
	var x193 uint64
	cmovznzU64(&x193, uint1(x191), x184, x175)
	var x194 uint64
	cmovznzU64(&x194, uint1(x191), x186, x177)
	var x195 uint64
	cmovznzU64(&x195, uint1(x191), x188, x179)
	out1[0] = x192
	out1[1] = x193
	out1[2] = x194
	out1[3] = x195
...
func Add(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x11 uint64
	var x12 uint64
	x11, x12 = bits.Sub64(x3, 0x14def9dea2f79cd6, uint64(uint1(x10)))
	var x13 uint64
	var x14 uint64
	x13, x14 = bits.Sub64(x5, uint64(0x0), uint64(uint1(x12)))
	var x15 uint64
	var x16 uint64
	x15, x16 = bits.Sub64(x7, 0x1000000000000000, uint64(uint1(x14)))
	var x18 uint64
...
func Sub(out1 *MontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement, arg2 *MontgomeryDomainFieldElement) {
	...
	var x12 uint64
	var x13 uint64
	x12, x13 = bits.Add64(x3, (x9 & 0x14def9dea2f79cd6), uint64(uint1(x11)))
	var x14 uint64
	var x15 uint64
	x14, x15 = bits.Add64(x5, uint64(0x0), uint64(uint1(x13)))
	var x16 uint64
	x16, _ = bits.Add64(x7, (x9 & 0x1000000000000000), uint64(uint1(x15)))
	out1[0] = x10
	out1[1] = x12
	out1[2] = x14
	out1[3] = x16
...
func FromMontgomery(out1 *NonMontgomeryDomainFieldElement, arg1 *MontgomeryDomainFieldElement) {
	...
	var x14 uint64
	var x15 uint64
	x14, x15 = bits.Add64(uint64(0x0), x10, uint64(uint1(x13)))
	var x16 uint64
	var x17 uint64
	...
	var x30 uint64
	var x31 uint64
	x30, x31 = bits.Add64((uint64(uint1(x17)) + (uint64(uint1(x15)) + (uint64(uint1(x11)) + x7))), x26, uint64(uint1(x29)))
	var x32 uint64
	var x33 uint64
	x32, x33 = bits.Add64(x4, (uint64(uint1(x27)) + x23), uint64(uint1(x31)))
	var x34 uint64
	var x35 uint64
	x34, x35 = bits.Add64(x5, x20, uint64(uint1(x33)))
	var x36 uint64
	var x37 uint64
	x36, x37 = bits.Add64(x30, arg1[2], uint64(0x0))
	var x38 uint64
	var x39 uint64
	x38, x39 = bits.Add64(x32, uint64(0x0), uint64(uint1(x37)))
	var x40 uint64
	var x41 uint64
	x40, x41 = bits.Add64(x34, uint64(0x0), uint64(uint1(x39)))
	var x42 uint64
	...
	var x54 uint64
	var x55 uint64
	x54, x55 = bits.Add64(x38, x50, uint64(uint1(x53)))
	var x56 uint64
	var x57 uint64
	x56, x57 = bits.Add64(x40, (uint64(uint1(x51)) + x47), uint64(uint1(x55)))
	var x58 uint64
	var x59 uint64
	x58, x59 = bits.Add64((uint64(uint1(x41)) + (uint64(uint1(x35)) + x21)), x44, uint64(uint1(x57)))
	var x60 uint64
	var x61 uint64
	x60, x61 = bits.Add64(x54, arg1[3], uint64(0x0))
	var x62 uint64
	var x63 uint64
	x62, x63 = bits.Add64(x56, uint64(0x0), uint64(uint1(x61)))
	var x64 uint64
	var x65 uint64
	x64, x65 = bits.Add64(x58, uint64(0x0), uint64(uint1(x63)))
	var x66 uint64
	...
	var x78 uint64
	var x79 uint64
	x78, x79 = bits.Add64(x62, x74, uint64(uint1(x77)))
	var x80 uint64
	var x81 uint64
	x80, x81 = bits.Add64(x64, (uint64(uint1(x75)) + x71), uint64(uint1(x79)))
	var x82 uint64
	var x83 uint64
	x82, x83 = bits.Add64((uint64(uint1(x65)) + (uint64(uint1(x59)) + x45)), x68, uint64(uint1(x81)))
	x84 := (uint64(uint1(x83)) + x69)
	var x85 uint64
	var x86 uint64
	x85, x86 = bits.Sub64(x78, 0x5812631a5cf5d3ed, uint64(0x0))
	var x87 uint64
	var x88 uint64
	x87, x88 = bits.Sub64(x80, 0x14def9dea2f79cd6, uint64(uint1(x86)))
	var x89 uint64
	var x90 uint64
	x89, x90 = bits.Sub64(x82, uint64(0x0), uint64(uint1(x88)))
	var x91 uint64
	var x92 uint64
	x91, x92 = bits.Sub64(x84, 0x1000000000000000, uint64(uint1(x90)))
	var x94 uint64
	_, x94 = bits.Sub64(uint64(0x0), uint64(0x0), uint64(uint1(x92)))
	var x95 uint64
	cmovznzU64(&x95, uint1(x94), x85, x78)
	var x96 uint64
	cmovznzU64(&x96, uint1(x94), x87, x80)
	var x97 uint64
	cmovznzU64(&x97, uint1(x94), x89, x82)
	var x98 uint64
	cmovznzU64(&x98, uint1(x94), x91, x84)
	out1[0] = x95
	out1[1] = x96
	out1[2] = x97
	out1[3] = x98
...
func ToMontgomery(out1 *MontgomeryDomainFieldElement, arg1 *NonMontgomeryDomainFieldElement) {
	...
	var x31 uint64
	var x32 uint64
	x31, x32 = bits.Add64(x13, x27, uint64(uint1(x30)))
	var x33 uint64
	var x34 uint64
	x33, x34 = bits.Add64(x15, (uint64(uint1(x28)) + x24), uint64(uint1(x32)))
	var x35 uint64
	var x36 uint64
	x35, x36 = bits.Add64(x17, x21, uint64(uint1(x34)))
	var x37 uint64
	var x38 uint64
	...
	var x53 uint64
	var x54 uint64
	x53, x54 = bits.Add64(x33, x45, uint64(uint1(x52)))
	var x55 uint64
	var x56 uint64
	x55, x56 = bits.Add64(x35, x47, uint64(uint1(x54)))
	var x57 uint64
	var x58 uint64
	x57, x58 = bits.Add64(((uint64(uint1(x36)) + (uint64(uint1(x18)) + x6)) + x22), x49, uint64(uint1(x56)))
	var x59 uint64
	...
	var x71 uint64
	var x72 uint64
	x71, x72 = bits.Add64(x53, x67, uint64(uint1(x70)))
	var x73 uint64
	var x74 uint64
	x73, x74 = bits.Add64(x55, (uint64(uint1(x68)) + x64), uint64(uint1(x72)))
	var x75 uint64
	var x76 uint64
	x75, x76 = bits.Add64(x57, x61, uint64(uint1(x74)))
	var x77 uint64
	var x78 uint64
	...
	var x93 uint64
	var x94 uint64
	x93, x94 = bits.Add64(x73, x85, uint64(uint1(x92)))
	var x95 uint64
	var x96 uint64
	x95, x96 = bits.Add64(x75, x87, uint64(uint1(x94)))
	var x97 uint64
	var x98 uint64
	x97, x98 = bits.Add64(((uint64(uint1(x76)) + (uint64(uint1(x58)) + (uint64(uint1(x50)) + x38))) + x62), x89, uint64(uint1(x96)))
	var x99 uint64
	...
	var x111 uint64
	var x112 uint64
	x111, x112 = bits.Add64(x93, x107, uint64(uint1(x110)))
	var x113 uint64
	var x114 uint64
	x113, x114 = bits.Add64(x95, (uint64(uint1(x108)) + x104), uint64(uint1(x112)))
	var x115 uint64
	var x116 uint64
	x115, x116 = bits.Add64(x97, x101, uint64(uint1(x114)))
	var x117 uint64
	var x118 uint64
	...
	var x133 uint64
	var x134 uint64
	x133, x134 = bits.Add64(x113, x125, uint64(uint1(x132)))
	var x135 uint64
	var x136 uint64
	x135, x136 = bits.Add64(x115, x127, uint64(uint1(x134)))
	var x137 uint64
	var x138 uint64
	x137, x138 = bits.Add64(((uint64(uint1(x116)) + (uint64(uint1(x98)) + (uint64(uint1(x90)) + x78))) + x102), x129, uint64(uint1(x136)))
	var x139 uint64
	...
	var x151 uint64
	var x152 uint64
	x151, x152 = bits.Add64(x133, x147, uint64(uint1(x150)))
	var x153 uint64
	var x154 uint64
	x153, x154 = bits.Add64(x135, (uint64(uint1(x148)) + x144), uint64(uint1(x152)))
	var x155 uint64
	var x156 uint64
	x155, x156 = bits.Add64(x137, x141, uint64(uint1(x154)))
	x157 := ((uint64(uint1(x156)) + (uint64(uint1(x138)) + (uint64(uint1(x130)) + x118))) + x142)
	var x158 uint64
	var x159 uint64
	x158, x159 = bits.Sub64(x151, 0x5812631a5cf5d3ed, uint64(0x0))
	var x160 uint64
	var x161 uint64
	x160, x161 = bits.Sub64(x153, 0x14def9dea2f79cd6, uint64(uint1(x159)))
	var x162 uint64
	var x163 uint64
	x162, x163 = bits.Sub64(x155, uint64(0x0), uint64(uint1(x161)))
	var x164 uint64
	var x165 uint64
	x164, x165 = bits.Sub64(x157, 0x1000000000000000, uint64(uint1(x163)))
	var x167 uint64
	_, x167 = bits.Sub64(uint64(0x0), uint64(0x0), uint64(uint1(x165)))
	var x168 uint64
	cmovznzU64(&x168, uint1(x167), x158, x151)
	var x169 uint64
	cmovznzU64(&x169, uint1(x167), x160, x153)
	var x170 uint64
	cmovznzU64(&x170, uint1(x167), x162, x155)
	var x171 uint64
	cmovznzU64(&x171, uint1(x167), x164, x157)
	out1[0] = x168
	out1[1] = x169
	out1[2] = x170
	out1[3] = x171
...
func Divstep(out1 *uint64, out2 *[5]uint64, out3 *[5]uint64, out4 *[4]uint64, out5 *[4]uint64, arg1 uint64, arg2 *[5]uint64, arg3 *[5]uint64, arg4 *[4]uint64, arg5 *[4]uint64) {
	...
	var x41 uint64
	var x42 uint64
	x41, x42 = bits.Sub64(x33, 0x14def9dea2f79cd6, uint64(uint1(x40)))
	var x43 uint64
	var x44 uint64
	x43, x44 = bits.Sub64(x35, uint64(0x0), uint64(uint1(x42)))
	var x45 uint64
	var x46 uint64
	x45, x46 = bits.Sub64(x37, 0x1000000000000000, uint64(uint1(x44)))
	var x48 uint64
	...
	var x64 uint64
	var x65 uint64
	x64, x65 = bits.Add64(x55, (x61 & 0x14def9dea2f79cd6), uint64(uint1(x63)))
	var x66 uint64
	var x67 uint64
	x66, x67 = bits.Add64(x57, uint64(0x0), uint64(uint1(x65)))
	var x68 uint64
	x68, _ = bits.Add64(x59, (x61 & 0x1000000000000000), uint64(uint1(x67)))
	var x70 uint64
	...
	var x104 uint64
	var x105 uint64
	x104, x105 = bits.Sub64(x96, 0x14def9dea2f79cd6, uint64(uint1(x103)))
	var x106 uint64
	var x107 uint64
	x106, x107 = bits.Sub64(x98, uint64(0x0), uint64(uint1(x105)))
	var x108 uint64
	var x109 uint64
	x108, x109 = bits.Sub64(x100, 0x1000000000000000, uint64(uint1(x107)))
	var x111 uint64
